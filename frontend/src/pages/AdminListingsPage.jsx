                ...
                {listings.map((listing) => (
                  <div key={listing.annonce_id} className="listing-card">
                    ...
                    <div className="listing-meta">
                      ...
                      <div className="type-badge">{listing.type_bien || 'N/A'}</div>
                    </div>
                    <div className="listing-desc">{listing.description || 'Pas de description'}</div>
        ...
        <div className="modal-overlay" onClick={() => setDialog({ open: false, action: null, listingId: null })}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              <div>{dialog.action === 'approve' ? 'Approuver' : 'Rejeter'} cette annonce?</div>
