...
# from src.routes.chat import chat_bp  # TODO: Fix ChatMessage imports
...
def create_app(config_name: str = None) -> Flask:
    ...
    # app.register_blueprint(chat_bp)  # Chat temps réel avec WebSocket - TODO: Fix ChatMessage imports
